    ...
    <>
      ...
      <style jsx global>{`
        ...
        .cross-site-toggle::before {
          ...
          transition: all 0.3s ease;
          pointer-events: none;
          animation: pigTailWiggle 1s ease-in-out infinite;
        }

        @keyframes pigTailWiggle {
        ...
        @media (max-width: 400px) {
          ...
          .cross-site-toggle::before {
            ...
            animation: pigTailWiggleMobile 1s ease-in-out infinite;
          }

          @keyframes pigTailWiggleMobile {
            0%, 100% { transform: translateX(-50%) rotate(90deg); }
            25% { transform: translateX(-50%) rotate(95deg); }
